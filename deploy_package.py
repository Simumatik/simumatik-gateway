...
if PLATFORM=="win32":
    ...
    SIGNING_CERT = "SimumatikCodeSigningCertificate.pfx"
    PACKAGE_PATH = 'C:/Git/'
    ...
    subprocess.call(f"{SIGNTOOLS_PATH} sign /f {SIGNING_CERT} /fd SHA256 /p 11dce81f9e5a893ca23cc020da45157c85ed93a5 /t {TIMESTAMP_URL} dist/{PACKAGE}/{PACKAGE_EXECUTABLE}", shell=True)
