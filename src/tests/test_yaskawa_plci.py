...
from drivers.yaskawa_plci.yaskawa_plci import yaskawa_plci
...
if d.connect():
    ...
    while time.perf_counter()-t < 10:
        ...
        print(d.readVariables(['Test_output']), counter)
        d.writeVariables([('Test_input', counter%256)])
        counter += 1
